...
class NuvemCinzasDetail extends StatefulWidget {
  @override
  _NuvemCinzasDetailState createState() => _NuvemCinzasDetailState();
}

class _NuvemCinzasDetailState extends State<NuvemCinzasDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        ...
        children: <Widget>[
          Hero(
            tag: "background-Nuvem de cinzas",
            child: DecoratedBox(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                /*Align(
                    ...
                    child: Hero(
                        tag: "image-Nuvem de cinzas",
                        child: Container(
                          width: 0.93 * screenWidth,
                          height: 0.25 * screenHeight,
                          decoration: BoxDecoration(
                            image: DecorationImage(image: AssetImage("assets/images/nevoaseca.png"),
                            fit: BoxFit.cover
                            ),
                    ...
                    child: Padding(
                      ...
                      child: Center(
                        child: RichText(
                          text: TextSpan(
                            children: [
                              TextSpan(text: "Nuvem de cinzas", style: TextStyle(color: Color.fromARGB(255, 71, 65, 187), fontSize: 24, fontWeight: FontWeight.w700)),
                            ],
                          ),
                        ),
                      ),
                ...
                Padding(
                    ...
                    child: Text("As nuvens formadas por erupções vulcânicas assemelham-se, em geral, a nuvens cumuliformes fortemente desenvolvidas,"
                    "com protuberâncias que crescem rapidamente.", style: AppTheme.display2, textAlign: TextAlign.justify,),
                ),
                FlatButton(
                  child: Container(
