...
class ChuvaForteDetail extends StatefulWidget {
  @override
  _ChuvaForteDetailState createState() => _ChuvaForteDetailState();
}

class _ChuvaForteDetailState extends State<ChuvaForteDetail> {
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                /*Align(
                    ...
                    child: Hero(
                        tag: "image-Chuva Forte",
                        child: Container(
                          width: 0.93 * screenWidth,
                          height: 0.25 * screenHeight,
                          decoration: BoxDecoration(
                            image: DecorationImage(image: AssetImage("assets/images/chuva.png"),
                            fit: BoxFit.cover
                            ),
                    ...
                    child: Padding(
                      ...
                      child: Center(
                        child: RichText(
                          text: TextSpan(
                            children: [
                              TextSpan(text: "Chuva forte", style: TextStyle(color: Color.fromARGB(255, 71, 65, 187), fontSize: 24, fontWeight: FontWeight.w700)),
                            ],
                          ),
                        ),
                      ),
                ...
                Padding(
                    ...
                    child: Text("Chuva é um fenômeno meteorológico que resulta da precipitação das gotas líquidas ou sólidas da água das nuvens sobre a "
        "superfície da Terra. Nem toda chuva atinge a superfície: algumas evaporam-se enquanto ainda estão a cair, num fenômeno "
        "que recebe o nome de virga e que acontece principalmente em locais ou períodos de ar seco.", style: AppTheme.display2, textAlign: TextAlign.justify,),
                ),
                FlatButton(
                  child: Container(
