...
class RelampagosDetail extends StatefulWidget {
  @override
  _RelampagosDetailState createState() => _RelampagosDetailState();
}

class _RelampagosDetailState extends State<RelampagosDetail> {
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                /*Align(
                    ...
                    child: Hero(
                        tag: "image-Relampagos",
                        child: Container(
                          width: 0.93 * screenWidth,
                          height: 0.25 * screenHeight,
                          decoration: BoxDecoration(
                            image: DecorationImage(image: AssetImage("assets/images/relampagos.png"),
                            fit: BoxFit.cover
                            ),
                    ...
                    child: Padding(
                      ...
                      child: Center(
                        child: RichText(
                          text: TextSpan(
                            children: [
                              TextSpan(text: "Relampagos", style: TextStyle(color: Color.fromARGB(255, 71, 65, 187), fontSize: 24, fontWeight: FontWeight.w700)),
                            ],
                          ),
                        ),
                      ),
                ...
                Padding(
                    ...
                    child: Text("Um relâmpago é a situação meteorológica caracterizada pela presença de raios(luminosidade) e seu efeito acústico na "
        "atmosfera terrestre conhecida por trovão. Para um relâmpago se formar é necessário que exista elevação de ar úmido numa "
        "atmosfera instável.", style: AppTheme.display2, textAlign: TextAlign.justify,),
                ),
                FlatButton(
                  child: Container(
