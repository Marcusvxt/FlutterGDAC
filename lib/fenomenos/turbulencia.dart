...
class TurbulenciaDetail extends StatefulWidget {
  @override
  _TurbulenciaDetailState createState() => _TurbulenciaDetailState();
}

class _TurbulenciaDetailState extends State<TurbulenciaDetail> {
