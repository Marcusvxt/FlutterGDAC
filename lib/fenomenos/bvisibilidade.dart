...
class BVisibilidadeDetail extends StatefulWidget {
  @override
  _BVisibilidadeDetailState createState() => _BVisibilidadeDetailState();
}

class _BVisibilidadeDetailState extends State<BVisibilidadeDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        ...
        children: <Widget>[
          Hero(
            tag: "background-Baixa visibilidade",
            child: DecoratedBox(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                /*Align(
                    ...
                    child: Hero(
                        tag: "image-Baixa visibilidade",
                        child: Container(
                          width: 0.93 * screenWidth,
                          height: 0.25 * screenHeight,
                          decoration: BoxDecoration(
                            image: DecorationImage(image: AssetImage("assets/images/baixavisi.png"),
                            fit: BoxFit.cover
                            ),
                    ...
                    child: Padding(
                      ...
                      child: Center(
                        child: RichText(
                          text: TextSpan(
                            children: [
                              TextSpan(text: "Baixa visibilidade", style: TextStyle(color: Color.fromARGB(255, 71, 65, 187), fontSize: 24, fontWeight: FontWeight.w700)),
                            ],
                          ),
                        ),
                      ),
                ...
                Padding(
                    ...
                    child: Text("Visibilidade é o parâmetro utilizado em meteorologia para indicar a medida da distância a que um objeto ou luz pode ser claramente "
        ...
        "a distância em metros (ou milhas) a que um objeto pode ser avistado.", style: AppTheme.display2, textAlign: TextAlign.justify,),
                ),
                FlatButton(
                  child: Container(
